            ...
            <nav>
                ...
                <table style="width:50%; height:100px" align="center" border=0px>
                    ...
                    <td colspan="4" style="color:#873600; font-size:125%"><strong> Choose a Method:</strong></td>
                        <td><a href="/pw2final/view/mfsPay.php"> <button class="loginbutton" type="button">MFS</button></a></td>
                        <td><a href="/pw2final/view/cardPay.php"> <button class="loginbutton" type="button">CARD</button></a></td>
                    </tr>
