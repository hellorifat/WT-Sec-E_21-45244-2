    ...
    <body>
        <h1></h1>
            <table style="width:100%; border:0, align:center">
                ...
                <br>
                <form style="width:50%" method="POST" action="../controller/daloginVerify.php" enctype="">
                    <fieldset>
                        <legend><strong>Logging in as Admin</strong></legend>
                        <table>
                        <tr>
                    <td>
...
<tr>
    <td align="right" colspan="2"> Forgot Password? <a href="http://localhost:8085/pw2/view/dareset.php"> Reset Now</a></td>
</tr>
</table>
</fieldset>
                </form>
