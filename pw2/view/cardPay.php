...
<h1></h1>
            <table style="width:100%; border:0, align:center">
                ...
                <form style="width:50%" method="POST" action="../controller/cardVerify.php" enctype="">
                    <fieldset>
                        <legend><strong>Paying With A Card</strong></legend>
                        <table>
                        <tr>
    ...
    <tr>
                    <td><strong>Card Number:</strong> </td><td><input type="tel" name="card"  value="" inputmode="numeric" pattern="[0-9\s]{13,16}" 
                     maxlength="16" placeholder="xxxx xxxx xxxx xxxx" required>
                </td>
                    </tr>
                    <tr>
                    <td><strong>CVC/CVV:</strong></td><td><input type="number" name="cvc" value="" placeholder="xxx" pattern="[0-9\s]{3}" 
                     maxlength="3"></td> 
                    <td><strong>Expiry:</strong></td><td><input type="text" name="expiry" value="" placeholder="mm/yy"></td>
                </tr>
                    <tr>
                    <td>
