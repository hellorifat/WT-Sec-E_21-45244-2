...
<h1></h1>
            <table style="width:100%; border:0, align:center">
                ...
                <table style="width:50%; height:100px" align="center" border=0px>
                    <br><br>
                    <tr align="center">
                        <td><a href="/pw2/view/deposit.php"> <button style="background-color:#0B5345; color: White; border:none; padding:10px 30px" type="button">Deposit</button></a></td>
                        <td><a href="/pw2/view/wMoney.php"> <button style="background-color:#0B5345; color: White; border:none; padding:10px 30px" type="button">Withdraw Money</button></a></td>
                        <td><a href="/pw2/view/balance.php"> <button style="background-color:#0B5345; color: White; border:none; padding:10px 30px" type="button">Balance</button></a></td>
                    </tr>
